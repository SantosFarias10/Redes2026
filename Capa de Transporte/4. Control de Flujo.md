...
![](Screenshot_2026-06-22-18-52-18_31333.png)
...
![](Screenshot_2026-06-22-18-52-43_27545.png)
...
El problema es que el emisor y el receptor saben cosas distintas: el emisor sabe cuántos datos le gustaría enviar, pero no  cuántos puede enviar realmente. Mientras que el receptor sabe cuánto espacio libre tiene pero no cuándo el emisor querrá enviar.
...
1. **No se guardan las cabeceras:**
   En el esquema anterior, el receptor almacenaba paquetes completos, con cabeceras incluidas, que ocupan espacio. En TCP: sólo se guarda el payload útil del flujo, el buffer retiene más datos útiles en el mismo espacio.
...
![](Screenshot_2026-06-22-18-54-27_25181.png)
...
![](Screenshot_2026-06-22-18-55-01_28686.png)
...
![](Screenshot_2026-06-22-18-55-25_1477.png)
...
![](Screenshot_2026-06-22-18-57-04_21546.png)
...
Por ejemplo: ACK=1001 + SACK=[2001–3001, 4001–5001] → faltan los bytes 1001–2000 y 3001–4000
### Ventana cero
