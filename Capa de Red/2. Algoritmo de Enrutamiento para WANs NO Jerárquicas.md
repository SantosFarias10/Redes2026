...
## Problema del enrutamiento en WANs
...
![](Screenshot_2026-06-23-10-55-59_696.png)
* Grafo G= (N,E)
...
>[!tip] A este algoritmo se le llama inundación.
...
![](Screenshot_2026-06-23-10-58-11_1512.png)
Para evitar el problema de que las listas enlazadas pueden crecer sin limites, agregamos una columna llamada contador que indica el mayor número de secuencia tal que llegaron paquetes con todos los números de secuencia anteriores desde ese enrutador de origen
![](Screenshot_2026-06-23-10-58-34_19634.png)
...
![](Screenshot_2026-06-23-10-59-26_13379.png)
...
![](Screenshot_2026-06-23-11-01-33_30130.png)

### Ahora vemos la distribución confiable de los LSP.

>[!tip] Usamos inundación de difusión con registro de paquetes difundidos.
...
![](Screenshot_2026-06-23-11-03-00_26143.png)
...
![](Screenshot_2026-06-23-11-05-01_24530.png)

#### Problema
Si los números de secuencia vuelven a comenzar, reinará la confusión (el algoritmo de inundación no está preparado para eso). ¿Cómo evitar este problema?
...
* Para evitar que esto suceda se puede hacer que la información de un enrutador caído expire a lo largo de la red luego de caerse.
